...
function Robotic() {
  return (
    <div className='h-220 w-full heading'>
       <div>

           <div className="h-14 w-full rounded-xl"></div>

           <Link to='/products'>
            <h1 className='p-5 text-xl align-text-bottom text-white hover:text-blue-500'>
           ...
           <div className='mt-6 mx-auto w-[95%] max-w-6xl bg-white p-2 sm:p-3 flex flex-col lg:flex-row justify-evenly rounded-2xl'>
              ...
              <div className='w-full lg:w-[45%] mt-4 lg:mt-6 flex flex-col p-3'>
                 <h1 className='text-2xl sm:text-3xl font-bold mb-3 lg:mt-8 border-b-2 border-blue-700'>
                 ...
                 <div className='mt-5 sm:mt-7'>
                   ...
                   <div className='space-y-1 sm:space-y-3 text-gray-900'>
                     <div className='flex justify-between py-2 sm:py-3 border-b border-gray-200'>
                       <span className=''>Payload Capacity</span>
                       <span className=''>25 kg</span>
                     </div>
                     <div className='flex justify-between py-2 sm:py-3 border-b border-gray-200'>
                       <span className=''>Reach </span>
                       <span className=''>1850 mm</span>
                     </div>
                     <div className='flex justify-between py-2 sm:py-3 border-b border-gray-200'>
                       <span className=''>Repeatability</span>
                       <span className=''>±0.03 mm</span>
                     </div>
                     <div className='flex justify-between py-2 sm:py-3 border-b border-gray-200'>
                       <span className=''>Axes</span>
                       <span className=' mr-3'>6</span>
                     </div>
                     <div className='flex justify-between py-2 sm:py-3 border-b border-gray-200'>
                       <span className=''>Protection Rating</span>
                       <span className=''>IP67</span>
                     </div>
                   </div>
                 </div>
